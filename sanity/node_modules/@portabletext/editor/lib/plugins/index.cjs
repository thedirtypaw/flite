...
const oneLineBehaviors = [
  ...
  behaviors_index.defineBehavior({
    ...
    guard: ({
      ...
      const textBlocks = event.blocks.filter((block) => util_mergeTextBlocks.isTextBlock(snapshot.context, block));
