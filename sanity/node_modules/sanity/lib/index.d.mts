...
>(props: ArrayInputFunctionsProps<Item, TSchemaType>): JSX_2.Element | null
...
>(props: ArrayInputFunctionsProps<MemberType, SchemaType>): JSX_2.Element | null
 ...
 * @internal
 * */
export declare function ChangesError(): JSX_2.Element
 ...
 * @hidden
 */
export declare function CommentDeleteDialog(props: CommentDeleteDialogProps): JSX_2.Element
 ...
 * @internal
 */
export declare function createDefaultIcon(title: string, subtitle: string): JSX_2.Element
...
/** @internal */
export declare interface CreateLinkedSanityDocument extends SanityDocument {
 ...
 */
export declare function DefaultDocument(props: DefaultDocumentProps): React.JSX.Element
...
/** @beta */
export declare type DocumentField = Exclude<keyof SanityDocument, number>
...
declare interface DocumentFormOptions {
  ...
  comparisonValue?:
    ...
    | ((editState: EditStateFor) => Partial<SanityDocument_2>)
    | null
 ...
 * @internal
 */
declare function Event_2({event, showChangesBy}: TimelineItemProps): JSX_2.Element
export {Event_2 as Event}

/**
 * @internal
 */
export declare function EventsProvider({value, children}: EventsProviderProps): JSX_2.Element
...
export declare const GetFormValueProvider: {
  (props: {value: FormDocumentValue | undefined; children: ReactNode}): JSX_2.Element
  displayName: string
}
 ...
 */
export declare function isGoingToUnpublish(document: SanityDocument_2 | SanityDocumentLike): boolean
...
declare const RELEASE_DOCUMENT_TYPE: 'system.release'
 ...
 * @beta
 */
declare type ReleaseFinalDocumentState = {
  /** Document ID */
  id: string
}
 ...
 * @beta
 */
declare type ReleaseType = (typeof releaseTypes)[number]

/**
 * @beta
 */
declare const releaseTypes: readonly ['asap', 'scheduled', 'undecided']
...
export declare function SearchProvider({
  ...
  disabledDocumentIds,
  canDisableAction,
}: SearchProviderProps): JSX_2.Element
...
export declare function StudioAnnouncementsCard({
  ...
  onCardClick,
  onCardDismiss,
}: StudioAnnouncementCardProps): JSX_2.Element
...
export declare function StudioAnnouncementsDialog({
  ...
  onClose,
  mode,
}: StudioAnnouncementDialogProps): JSX_2.Element
...
declare const studioLocaleStrings: {
  ...
  /** "Latest version" header in about dialog */
  'about-dialog.version-info.latest-version.text': string
  ...
  'form.reconnecting.toast.title': string
 ...
 */
export declare function unstable_useObserveDocument<T extends SanityDocument>(
  documentId: string,
 ...
 */
export declare function useReferringDocuments<DocumentType extends SanityDocument>(
  id: string,
