...
`, Button = forwardRef(function(t0, ref) {
  ...
  let t2;
  $[6] !== footer || $[7] !== props || $[8] !== t ? (t2 = (footer?.confirmButton || footer?.cancelButton) && /* @__PURE__ */ jsxs(Flex, { width: "full", gap: 3, justify: "flex-end", padding: 3, align: "center", children: [
  ...
  let t4;
  $[10] !== bodyHeight || $[11] !== children || $[12] !== t3 ? (t4 = /* @__PURE__ */ jsx(Box, { height: bodyHeight, padding: t3, children }), $[10] = bodyHeight, $[11] = children, $[12] = t3, $[13] = t4) : t4 = $[13];
  let t5;
  return $[14] !== props || $[15] !== ref || $[16] !== t2 || $[17] !== t4 ? (t5 = /* @__PURE__ */ jsx(Dialog$1, { ...props, animate: !0, ref, footer: t2, children: t4 }), $[14] = props, $[15] = ref, $[16] = t2, $[17] = t4, $[18] = t5) : t5 = $[18], t5;
});
