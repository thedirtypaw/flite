"use strict";
var jsxRuntime = require("react/jsx-runtime"), React = require("react"), sanity = require("sanity"), _singletons = require("sanity/_singletons"), uniqueId = require("lodash/uniqueId.js"), reactIs = require("react-is"), icons = require("@sanity/icons"), camelCase = require("lodash/camelCase.js"), speakingurl = require("speakingurl"), uniq = require("lodash/uniq.js"), kebabCase = require("lodash/kebabCase.js"), generateHelpUrl_esm = require("./generate-help-url.esm.js"), find = require("lodash/find.js"), startCase = require("lodash/startCase.js");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var uniqueId__default = /* @__PURE__ */ _interopDefaultCompat(uniqueId), camelCase__default = /* @__PURE__ */ _interopDefaultCompat(camelCase), speakingurl__default = /* @__PURE__ */ _interopDefaultCompat(speakingurl), uniq__default = /* @__PURE__ */ _interopDefaultCompat(uniq), kebabCase__default = /* @__PURE__ */ _interopDefaultCompat(kebabCase), find__default = /* @__PURE__ */ _interopDefaultCompat(find), startCase__default = /* @__PURE__ */ _interopDefaultCompat(startCase);
...
class ListBuilder extends GenericListBuilder {
  ...
  serialize(options = {
    ...
    const path = (options.path || []).concat(id), serializedItems = items.map((item, index) => maybeSerializeListItem(item, index, path)), dupes = serializedItems.filter((val, i) => find__default.default(serializedItems, {
      id: val.id
    }, i + 1));
    if (dupes.length > 0) {
...
function getDocumentTypeList(context, typeNameOrSpec) {
  ...
  return new DocumentTypeListBuilder(context).id(spec.id || typeName).title(spec.title || title).filter("_type == $type").params({
    ...
    }).title("Compact view").icon(icons.StackCompactIcon).action("setLayout").params({
      layout: "default"
    }),
    new MenuItemBuilder(context).group("layout").i18n({
      title: {
    ...
    }).title("Detailed view").icon(icons.StackIcon).action("setLayout").params({
      layout: "detail"
    })
...
function StructureToolProvider({
  ...
  }), [layoutCollapsed]), structureTool = React.useMemo(() => ({
    features,
    layoutCollapsed,
    setLayoutCollapsed,
    rootPaneNode,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(_singletons.StructureToolContext.Provider, { value: structureTool, children });
}
...
exports.structureUsEnglishLocaleBundle = structureUsEnglishLocaleBundle;
