...
const StyledButton = /* @__PURE__ */ styled.button.withConfig({
  ...
  let t14;
  $[35] !== loading ? (t14 = !!loading && /* @__PURE__ */ jsx(LoadingBox, { children: /* @__PURE__ */ jsx(Spinner, {}) }), $[35] = loading, $[36] = t14) : t14 = $[36];
  let t15;
  ...
  let t16;
  $[49] !== boxProps || $[50] !== children ? (t16 = children && /* @__PURE__ */ jsx(Box, { as: "span", ...boxProps, children }), $[49] = boxProps, $[50] = children, $[51] = t16) : t16 = $[51];
  let t17;
...
const MotionCard$1 = styled(motion.create(Card)).withConfig({
  ...
  let t13;
  $[45] !== overflow || $[46] !== t12 ? (t13 = /* @__PURE__ */ jsx(MotionFlex, { "data-ui": "Popover__wrapper", direction: "column", flex: 1, overflow, variants: POPOVER_MOTION_PROPS.children, transition: POPOVER_MOTION_PROPS.transition, children: t12 }), $[45] = overflow, $[46] = t12, $[47] = t13) : t13 = $[47];
  let t14;
